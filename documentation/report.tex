...
\Section{abstract} This is a report describing the experimental results on the
...
\Section{Training method} \label{sec:train_method} The neural network is
...
\Section{Weight Initialization} \label{sec:weight_init} Neural Networks are
...
\Section{Experiments} We performed several experiments with the shallow neural
...
\bibliography{report}{References} \bibliographystyle{plain}
